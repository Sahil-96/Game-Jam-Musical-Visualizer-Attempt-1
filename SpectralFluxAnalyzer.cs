...
//most of this code was taking from an online tutorial ( I made the edit to determine where peaks were)
//This code takes an audio file, and produces three values: peak points (the heightest point a pitch reachs relative to its adjacent notes) 
//                                                          threshold points (the overall highest point that then scales other points to fit in window nicely)
//                                                          flux points (which consist of all non crucital information that create the noice and fall off for each note)
//I use this code in conjunction with my Plot Controller class to create platforms for my platformer game
...
public class SpectralFluxAnalyzer {
    ...
    //You compare the flux values of the values before and after it to recognize if it is a peak or not.  
